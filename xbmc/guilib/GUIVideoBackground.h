/*!
\file GUIVideoBackground.h
\brief
*/

#ifndef GUILIB_GUIVIDEOBACKGROUND_H
#define GUILIB_GUIVIDEOBACKGROUND_H
...
/*!
 ...
 \brief
 */
class CGUIVideoBackground :
      public CGUIControl, public IPlayerCallback
{
public:
  CGUIVideoBackground(int parentID, int controlID, float posX, float posY, float width, float height);
  virtual ~CGUIVideoBackground(void);
  virtual CGUIVideoBackground *Clone() const { return new CGUIVideoBackground(*this); };
...
//  IPlayer*       m_pPlayer;
  ...
  int	m_videoBackgroundId;

  SimpleVideoPlayer* m_pPlayer;
